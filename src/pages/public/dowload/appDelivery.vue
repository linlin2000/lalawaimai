<template>
	<div id="dowload-delivery">
		<div class="content">
			<div class="dow-btn-warp">
				<div class="dow-btn">
					<div class="dow" @click="onShowClick"><van-icon name='down'></van-icon>下载配送员客户端</div>
				</div>
			</div>
...
<style>
	#dowload-delivery .content{
		...
		overflow-x: hidden;
		overflow-y: scroll;
		background: url(../../../../static/img/app-delivery.png) no-repeat;
...
// WEBPACK FOOTER //
// src/pages/public/dowload/appDelivery.vue