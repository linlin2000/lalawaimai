<template>
    <div id="dowload-plateform">
        <div class="content">
            <div class="dow-btn-warp">
                <div class="dow-btn">
                    <div class="dow" @click="onShowClick"><van-icon name='down'></van-icon>下载平台管理端</div>
                </div>
            </div>
...
<script>
	export default {
		...
		mounted() {
			this.util.request({
				url: 'system/common/download/plateform',
				method: 'POST',
			}).then((result) => {
...
<style>
    #dowload-plateform .content{
        ...
        overflow-x: hidden;
        overflow-y: scroll;
        background: url(../../../../static/img/app-plateform.png) no-repeat;
...
// WEBPACK FOOTER //
// src/pages/public/dowload/appPlateform.vue