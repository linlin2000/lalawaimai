	...
	export default {
		...
		methods: {
			...
			onSubmit() {
				...
				this.$router.replace(this.util.getUrl({path: '/tangshi/pages/table/create', query: {sid: this.$route.query.sid, table_id: this.orderExtra.table_id}}));
			}
		},
		computed: {
			...mapState([
